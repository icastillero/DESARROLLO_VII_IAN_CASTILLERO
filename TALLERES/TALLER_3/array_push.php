...
$misAmigos = ["JORGE", "PEDRO", "SESE"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "ALBERTO", "ALDRICK"); // Reemplaza las comillas vacías con los nombres de tus amigos
