...
$miArray = ["PANAMA","DARIEN","CHIRIQUI"]; // Reemplaza esto con tu propio array
$miString = "icastillero"; // Reemplaza esto con tu propio string
$miNumero = 20; // Reemplaza esto con tu propio número
